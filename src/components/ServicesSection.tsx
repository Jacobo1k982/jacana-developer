...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#0d1117]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3 font-sans">
            Servicios
          </h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm md:text-base font-sans">
